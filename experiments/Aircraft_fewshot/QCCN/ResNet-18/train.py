...
sys.path.append('../../../../')
from trainers import trainer, qccn_train
...
model = QCCN(way=train_way,
            shots=[args.train_shot, args.train_query_shot],
            resnet=args.resnet, resnet18=args.resnet18)

train_func = partial(qccn_train.default_train,train_loader=train_loader)
