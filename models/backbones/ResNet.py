...
def resnet18(drop_rate=0.0, max_pool=True, **kwargs):
    """Constructs a ResNet-18 model.
    """
    model = ResNet(BasicBlock, [2, 2, 1, 1], drop_rate=drop_rate, max_pool=max_pool, **kwargs)
    return model
